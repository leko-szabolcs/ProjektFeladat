...
```
cd existing_repo
git remote add origin https://gitlab.ibcontroll.hu/gamf_projektfeladat_2024/okosreceptkonyv.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.ibcontroll.hu/gamf_projektfeladat_2024/okosreceptkonyv/-/settings/integrations)
